(provide br/inf/ufpr/jessmre/procedures/core/incorrectfetch/twocolumn/smaller_from_larger_except_last)
...
(assert (subtraction (top 7 3 3) (bottom 2 4 6)))
(assert (desirable (result 4 9 3)))
