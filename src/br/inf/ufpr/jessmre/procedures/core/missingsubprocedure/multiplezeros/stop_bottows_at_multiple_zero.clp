(provide br/inf/ufpr/jessmre/procedures/core/missingsubprocedure/multiplezeros/stop_borrow_at_multiple_zero)
(require br/inf/ufpr/jessmre/procedures/commons/templates)
(require br/inf/ufpr/jessmre/procedures/commons/functions)


; Caso tenha que emprestar de multiplos zeros, o estudante ignora o decremento
...
(assert (desirable (result 3 0 0 8)))
