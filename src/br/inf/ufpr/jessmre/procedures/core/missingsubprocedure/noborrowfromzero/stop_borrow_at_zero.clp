(provide br/inf/ufpr/jessmre/procedures/core/missingsubprocedure/noborrowfromzero/stop_borrow_at_zero)
(require br/inf/ufpr/jessmre/procedures/commons/templates)
(require br/inf/ufpr/jessmre/procedures/commons/functions)

;; Repairs impasse by skipping the stuck subgoal of borrow. Correctly performs other subgoals.

; Repara o impasse não decrementando o zero
; Alteração na regra decr-borrow.
; Desempilha objetivo de decrementar.
