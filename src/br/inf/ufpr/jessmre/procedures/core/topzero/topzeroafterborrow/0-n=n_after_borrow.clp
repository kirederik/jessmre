(provide br/inf/ufpr/jessmre/procedures/core/topzero/topzeroafterborrow/0-n=n_after_borrow)
...
(assert (subtraction (top 5 1 2) (bottom 1 3 6)))
(assert (desirable (result 4 3 6)))
