(provide br/inf/ufpr/jessmre/procedures/core/topzero/topzero/treat_top_zero_as_nine)
...
;(assert (subtraction (top 3 0) (bottom 4)))
;(assert (desirable (result 3 5)))
