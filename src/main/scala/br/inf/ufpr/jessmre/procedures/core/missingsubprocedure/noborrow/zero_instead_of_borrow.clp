(provide br/inf/ufpr/jessmre/procedures/core/missingsubprocedure/nopartialcolumns/zero_instead_of_borrow)
(require br/inf/ufpr/jessmre/procedures/commons/templates)
(require br/inf/ufpr/jessmre/procedures/commons/functions)

;; Repairs impasse by writing the smallest number know, 0

; Repara escrevendo o menor número conhecido: 0
; Alteração na regra sub1col-borrow.
; Escreve 0 no resultado.
