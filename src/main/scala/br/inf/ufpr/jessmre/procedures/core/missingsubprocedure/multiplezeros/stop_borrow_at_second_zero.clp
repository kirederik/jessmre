(provide br/inf/ufpr/jessmre/procedures/core/missingsubprocedure/multiplezeros/stop_borrow_at_second_zero)
(require br/inf/ufpr/jessmre/procedures/commons/templates)
(require br/inf/ufpr/jessmre/procedures/commons/functions)

(deftemplate borrowed-across (slot has))
; Decrementa corretamente o primeiro zero. Reinterpreta a localização do decremento como sendo a próxima coluna diferente de zero.
...
(assert (borrowed-across (has 0)))
;(assert (subtraction (top 3 0 0 5) (bottom 7)))
;(assert (desirable (result 2 0 9 8)))
