(provide br/inf/ufpr/jessmre/procedures/core/topzero/topzero/treat_top_zero_as_ten)
...
;(assert (subtraction (top 4 0) (bottom 2 7)))
;(assert (desirable (result 2 3)))
