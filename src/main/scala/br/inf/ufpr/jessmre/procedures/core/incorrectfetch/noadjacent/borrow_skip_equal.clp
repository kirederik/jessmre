(provide br/inf/ufpr/jessmre/procedures/core/incorrectfetch/noadjacent/borrow_skip_equal)
...
;(assert (subtraction (top 9 2 3) (bottom 4 2 7)))
;(assert (desirable (result 4 0 6)))
