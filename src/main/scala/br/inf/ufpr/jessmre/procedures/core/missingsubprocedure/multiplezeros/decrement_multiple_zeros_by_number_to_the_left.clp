(provide br/inf/ufpr/jessmre/procedures/core/missingsubprocedure/multiplezeros/decrement_multiple_zero_by_number_to_the_left)

(require br/inf/ufpr/jessmre/procedures/commons/templates)
(require br/inf/ufpr/jessmre/procedures/commons/functions)

(deftemplate decr-amount (slot amount))
...
(assert (decr-amount (amount 0)))
;(assert (subtraction (top 3 0 0 0 0 5) (bottom 7)))
;(assert (desirable (result 2 9 8 7 6 8)))
