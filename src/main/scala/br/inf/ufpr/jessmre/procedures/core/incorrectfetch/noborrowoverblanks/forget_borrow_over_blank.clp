(provide br/inf/ufpr/jessmre/procedures/core/incorrectfetch/noborrowoverblanks/forget_borrow_over_blanks)
...
;(assert (subtraction (top 3 4 7) (bottom 9)))
;(assert (desirable (result 3 4 8)))
