(provide br/inf/ufpr/jessmre/procedures/core/incorrectfetch/borrowfromzero/borrow_acr_zero_over_zero)
...
;(assert (subtraction (top 8 0 2) (bottom 3 0 4)))
;(assert (desirable (result 4 0 8)))
