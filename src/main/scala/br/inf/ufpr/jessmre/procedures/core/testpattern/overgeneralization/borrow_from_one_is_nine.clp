(provide br/inf/ufpr/jessmre/procedures/core/testpattern/overgeneralization/borrow_from_one_is_nine)
...
;(assert (subtraction (top 3 1 6) (bottom 1 3 9)))
;(assert (desirable (result 2 6 7)))
