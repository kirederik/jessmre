(provide br/inf/ufpr/jessmre/procedures/core/topzero/topzeroafterborrow/1-1=0_after_borrow)
...
;(assert (subtraction (top 8 1 2) (bottom 5 1 8)))
;(assert (desirable (result 3 0 4)))
