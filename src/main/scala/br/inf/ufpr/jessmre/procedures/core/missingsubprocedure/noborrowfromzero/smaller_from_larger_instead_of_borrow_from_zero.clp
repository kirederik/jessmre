(provide br/inf/ufpr/jessmre/procedures/core/missingsubprocedure/noborrowfromzero/smaller_from_larger_instead_of_borrom_from_zero)
(require br/inf/ufpr/jessmre/procedures/commons/templates)
(require br/inf/ufpr/jessmre/procedures/commons/functions)

;; Absolute difference instead of borrowing if the borrow is from zero

; Caso tenha que decrementar 0, calcula a diferença absoluta (maior - menor)
; Alteração na regra borrow.
