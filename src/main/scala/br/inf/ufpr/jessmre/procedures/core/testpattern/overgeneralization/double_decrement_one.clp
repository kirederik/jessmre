(provide br/inf/ufpr/jessmre/procedures/core/testpattern/overgeneralization/borrow_treat_one_as_zero)
...
;(assert (subtraction (top 8 1 1 3) (bottom 5 6 8)))
;(assert (desirable (result 8 4 3 5)))
