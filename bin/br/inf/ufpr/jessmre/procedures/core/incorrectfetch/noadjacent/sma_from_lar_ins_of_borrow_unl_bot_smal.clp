(provide br/inf/ufpr/jessmre/procedures/core/incorrectfetch/noadjacent/sma_from_lar_ins_of_borrow_unl_bot_smal)
...
(assert (subtraction (top 7 3 2) (bottom 4 3 4)))
(assert (desirable (result  3 0 2)))
