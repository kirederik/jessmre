(provide br/inf/ufpr/jessmre/procedures/core/incorrectfetch/twocolumn/always_borrow_left)
...
(assert (subtraction (top 7 3 3) (bottom 2 1 6)))
(assert (desirable (result 4 2 7)))
