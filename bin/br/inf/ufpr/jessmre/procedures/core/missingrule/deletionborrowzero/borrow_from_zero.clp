(provide br/inf/ufpr/jessmre/procedures/core/missingrule/deletionborrowzero/borrow_from_zero)

(require br/inf/ufpr/jessmre/procedures/commons/templates)
(require br/inf/ufpr/jessmre/procedures/commons/functions)


;; Instead of borrowing across a 0, the student changes the 0 to 9, 
;;   but does not continue borrowing from the column to the left

; Muda o zero para 9, mas não decrementa da esquerda.
