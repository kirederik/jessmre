(provide br/inf/ufpr/jessmre/procedures/core/missingrule/deletionborrowzero/borrow_from_zero_is_ten)
...
(assert (subtraction (top 3 0 0 6) (bottom 1 8 0 7)))
(assert (desirable (result 2 1 9 9)))
