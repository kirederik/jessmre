(provide br/inf/ufpr/jessmre/procedures/core/missingrule/deletionborrowing/borrow_no_decrement)
...
(assert (subtraction (top 6 2) (bottom 4 4)))
(assert (desirable (result 2 8)))
