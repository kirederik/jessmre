(provide br/inf/ufpr/jessmre/procedures/core/missingsubprocedure/nopartialcolumns/stutter_subtract)

(require br/inf/ufpr/jessmre/procedures/commons/templates)
(require br/inf/ufpr/jessmre/procedures/commons/functions)

;; Repairs impasse by using the last bottom digit as the missing one

; Repara o impasse quando não há dígito na parte de baixo utilizando o último dígito como o faltante
; Alteração na regra subtract-no-bottom.
; Empilha objetivo de subtrair as colunas sem digito embaixo usando a cabeça da bottom list
...
(assert (subtraction (top 9 6 8) (bottom 5)))
(assert (desirable (result 4 1 3)))
